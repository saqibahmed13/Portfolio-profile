...
export const Banner = () => {
  ...
  const toRotate = ["Front End Developer", "React Js Developer", "Full Stack Developer"];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Saqib`} <span className="txt-rotate" dataPeriod="1000" data-rotate='["Front End Developer", "React Js Developer", "Full Stack Developer"]'><span className="wrap">{text}</span></span></h1>
